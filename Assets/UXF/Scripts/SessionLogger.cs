...
namespace UXF
{
	...
	{	
		...
		{
			table = new UXFDataTable("host_timestamp", "unity_timestamp"/*, "varjo_timestamp"*/, "log_type", "message", "stacktrace");
		...
		void HandleLog(string logString, string stackTrace, LogType type)
		{
			...
			// row.Add(("varjo_timestamp", Varjo.XR.VarjoTime.GetVarjoTimestamp().ToString()));
