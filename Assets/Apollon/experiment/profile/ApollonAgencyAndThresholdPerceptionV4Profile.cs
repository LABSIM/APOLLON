...
namespace Labsim.apollon.experiment.profile
{
    ...
    public class ApollonAgencyAndThresholdPerceptionV4Profile 
        : ApollonAbstractExperimentFiniteStateMachine< ApollonAgencyAndThresholdPerceptionV4Profile >
    {

        // Ctor
        public ApollonAgencyAndThresholdPerceptionV4Profile()
            : base()
        {
            // default profile
            this.m_profileID = ApollonExperimentManager.ProfileIDType.AgencyAndThresholdPerceptionV4;
        }

        // fast hack
        public uint
            downConditionCount = 0,
            upConditionCount = 0;
        ...
        public class Settings
        {
            ...
            private string GetJSONSettingsAttributeName<T>(string field_name)
            {
                ...
                catch(System.Exception ex)
                {
                    ...
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.Settings.GetJSONSettingsAttributeName() : failed to extract ("
                        + field_name
                        + ") with error ["
                        + ex.Message
                        + "]"
            ...
            public enum SideIDType
            {
                ...
                [System.ComponentModel.Description("Up")]
                Up = 3,

                [System.ComponentModel.Description("Down")]
                Down = 4,
            ...
            public enum FogIDType
            {
                ...
                [System.ComponentModel.Description("Exponential")]
                Exponential = 2,

                [System.ComponentModel.Description("Exponential_Squared")]
            ...
            [JSONSettingsAttribute("passive_side_name")]
            public SideIDType passive_side_type;

            [JSONSettingsAttribute("with_visual_degradation")]
            public bool bWithVisualDegradation;
            
            [JSONSettingsAttribute("visual_degradation_fog_mode_name")]
            public FogIDType fog_type;

            [JSONSettingsAttribute("visual_degradation_fog_color")]
            public float[] fog_color = new float[3] { 1.0f, 1.0f, 1.0f };
 
            [JSONSettingsAttribute("visual_degradation_fog_density")]
            public float fog_density;

            [JSONSettingsAttribute(settings: "visual_degradation_fog_start_distance", unit:"m")]
            public float fog_start_distance;
            
            [JSONSettingsAttribute(settings: "visual_degradation_fog_end_distance", unit:"m")]
            ...
            public class PhaseBSettings
            {
                ...
                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_strong_acceleration_scale_from_reference", unit:"ratio")]
                public float[] primary_angular_strong_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_weak_acceleration_scale_from_reference", unit:"ratio")]
                public float[] primary_angular_weak_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_down_acceleration_rotation_from_reference", unit:"deg")]
                public float[] primary_angular_down_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_up_acceleration_rotation_from_reference", unit:"deg")]
                public float[] primary_angular_up_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };


                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_velocity_saturation_threshold", unit:"deg_per_s")]
                public float[] primary_angular_velocity_saturation_threshold = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_angular_displacement_limiter", unit:"deg")]
                public float[] primary_angular_displacement_limiter = new float[3] { 0.0f, 0.0f, 0.0f };
                ...
                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_strong_acceleration_scale_from_reference", unit:"ratio")]
                public float[] primary_linear_strong_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_weak_acceleration_scale_from_reference", unit:"ratio")]
                public float[] primary_linear_weak_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_down_acceleration_rotation_from_reference", unit:"deg")]
                public float[] primary_linear_down_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_up_acceleration_rotation_from_reference", unit:"deg")]
                public float[] primary_linear_up_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };


                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_velocity_saturation_threshold", unit:"m_per_s")]
                public float[] primary_linear_velocity_saturation_threshold = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"primary_linear_displacement_limiter", unit:"m")]
                public float[] primary_linear_displacement_limiter = new float[3] { 0.0f, 0.0f, 0.0f };
                ...
                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_strong_acceleration_scale_from_reference", unit:"ratio")]
                public float[] secondary_angular_strong_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_weak_acceleration_scale_from_reference", unit:"ratio")]
                public float[] secondary_angular_weak_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_down_acceleration_rotation_from_reference", unit:"deg")]
                public float[] secondary_angular_down_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_up_acceleration_rotation_from_reference", unit:"deg")]
                public float[] secondary_angular_up_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };


                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_velocity_saturation_threshold", unit:"deg_per_s")]
                public float[] secondary_angular_velocity_saturation_threshold = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_angular_displacement_limiter", unit:"deg")]
                public float[] secondary_angular_displacement_limiter = new float[3] { 0.0f, 0.0f, 0.0f };
                ...
                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_strong_acceleration_scale_from_reference", unit:"ratio")]
                public float[] secondary_linear_strong_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_weak_acceleration_scale_from_reference", unit:"ratio")]
                public float[] secondary_linear_weak_acceleration_scale_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_down_acceleration_rotation_from_reference", unit:"deg")]
                public float[] secondary_linear_down_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_up_acceleration_rotation_from_reference", unit:"deg")]
                public float[] secondary_linear_up_acceleration_rotation_from_reference = new float[3] { 0.0f, 0.0f, 0.0f };


                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_velocity_saturation_threshold", unit:"m_per_s")]
                public float[] secondary_linear_velocity_saturation_threshold = new float[3] { 0.0f, 0.0f, 0.0f };

                [JSONSettingsAttribute(phase:"phase_B", settings:"secondary_linear_displacement_limiter", unit:"m")]
                public float[] secondary_linear_displacement_limiter = new float[3] { 0.0f, 0.0f, 0.0f };
            ...
            public bool ImportUXFSettings(UXF.Settings settings)
            {
                ...
                try
                {
                    ...
                    // current passive side
                    switch(
                        settings.GetString(
                            this.GetJSONSettingsAttributeName<Settings>("passive_side_type")
                        )
                    ) {
                        
                        // Left
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.SideIDType.Left),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.passive_side_type = Settings.SideIDType.Left;
                            break;
                        }

                        // Right
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.SideIDType.Right),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.passive_side_type = Settings.SideIDType.Right;
                            break;
                        }

                        // Up
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.SideIDType.Up),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.passive_side_type = Settings.SideIDType.Up;
                            break;
                        }

                        // Down
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.SideIDType.Down),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.passive_side_type = Settings.SideIDType.Down;
                            break;
                        }
                        ...
                        default: 
                        {
                            this.passive_side_type = Settings.SideIDType.Undefined;
                            break;
                        }
                    ...
                    // has degradation
                    this.bWithVisualDegradation 
                        = settings.GetBool(
                            this.GetJSONSettingsAttributeName<Settings>("bWithVisualDegradation")
                        );

                    // current fog type
                    switch(
                        settings.GetString(
                            this.GetJSONSettingsAttributeName<Settings>("fog_type")
                        )
                    ) {
                        
                        // linear
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.FogIDType.Linear),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.fog_type = Settings.FogIDType.Linear;
                            break;
                        }

                        // exp
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.FogIDType.Exponential),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.fog_type = Settings.FogIDType.Exponential;
                            break;
                        }
                        
                        // exp2
                        case string param when param.Equals(
                            ApollonEngine.GetEnumDescription(Settings.FogIDType.ExponentialSquared),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                            this.fog_type = Settings.FogIDType.ExponentialSquared;
                            break;
                        }
                        ...
                        default: 
                        {
                            this.fog_type = Settings.FogIDType.Undefined;
                            break;
                        }
                    ...
                    this.fog_color
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings>("fog_color")
                        ).ToArray();
                    this.fog_density
                        = settings.GetFloat(
                            this.GetJSONSettingsAttributeName<Settings>("fog_density")
                        );
                    this.fog_start_distance
                        = settings.GetFloat(
                            this.GetJSONSettingsAttributeName<Settings>("fog_start_distance")
                        );
                    this.fog_end_distance
                        = settings.GetFloat(
                            this.GetJSONSettingsAttributeName<Settings>("fog_end_distance")
                        );
                   ...
                   this.phase_B_settings.primary_angular_strong_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_strong_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_angular_weak_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_weak_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_angular_down_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_down_acceleration_rotation_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_angular_up_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_up_acceleration_rotation_from_reference")
                        ).ToArray();

                    this.phase_B_settings.primary_angular_velocity_saturation_threshold
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_velocity_saturation_threshold")
                        ).ToArray();
                    this.phase_B_settings.primary_angular_displacement_limiter
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_displacement_limiter")
                        ).ToArray();
                   ...
                   this.phase_B_settings.primary_linear_strong_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_strong_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_linear_weak_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_weak_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_linear_down_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_down_acceleration_rotation_from_reference")
                        ).ToArray();
                    this.phase_B_settings.primary_linear_up_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_up_acceleration_rotation_from_reference")
                        ).ToArray();

                    this.phase_B_settings.primary_linear_velocity_saturation_threshold
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_velocity_saturation_threshold")
                        ).ToArray();
                    this.phase_B_settings.primary_linear_displacement_limiter
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_displacement_limiter")
                        ).ToArray();
                    ...
                    this.phase_B_settings.secondary_angular_strong_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_strong_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_angular_weak_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_weak_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_angular_down_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_down_acceleration_rotation_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_angular_up_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_up_acceleration_rotation_from_reference")
                        ).ToArray();

                    this.phase_B_settings.secondary_angular_velocity_saturation_threshold
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_velocity_saturation_threshold")
                        ).ToArray();
                    this.phase_B_settings.secondary_angular_displacement_limiter
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_displacement_limiter")
                        ).ToArray();
                   ...
                   this.phase_B_settings.secondary_linear_strong_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_strong_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_linear_weak_acceleration_scale_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_weak_acceleration_scale_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_linear_down_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_down_acceleration_rotation_from_reference")
                        ).ToArray();
                    this.phase_B_settings.secondary_linear_up_acceleration_rotation_from_reference
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_up_acceleration_rotation_from_reference")
                        ).ToArray();

                    this.phase_B_settings.secondary_linear_velocity_saturation_threshold
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_velocity_saturation_threshold")
                        ).ToArray();
                    this.phase_B_settings.secondary_linear_displacement_limiter
                        = settings.GetFloatList(
                            this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_displacement_limiter")
                        ).ToArray();
                ...
                catch(System.Exception ex)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.Settings.ImportUXFSettings() : failed to import settings with error ["
                        + ex.Message
                        + "]"
                    );
            ...
            public void LogUXFSettings()
            {
                ...
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.Settings.LogUXFSettings() : imported current settings with pattern["
                        + this.pattern_type
                    + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("bIsTryCatch") 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("passive_side_type") 
                        + " : " 
                        + ApollonEngine.GetEnumDescription(this.passive_side_type)
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("bWithVisualDegradation") 
                        + " : " 
                        + this.bWithVisualDegradation
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("fog_type") 
                        + " : " 
                        + ApollonEngine.GetEnumDescription(this.fog_type)
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("fog_color") 
                        + " : [" 
                            + System.String.Join(",",this.fog_color) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("fog_density") 
                        + " : " 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_strong_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_strong_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_weak_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_weak_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_down_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_down_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_up_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_up_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_velocity_saturation_threshold") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_velocity_saturation_threshold) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_displacement_limiter") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_angular_displacement_limiter) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_angular_mandatory_axis") 
                        + " : [" 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_strong_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_strong_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_weak_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_weak_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_down_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_down_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_up_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_up_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_velocity_saturation_threshold") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_velocity_saturation_threshold) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_displacement_limiter") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.primary_linear_displacement_limiter) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("primary_linear_mandatory_axis") 
                        + " : [" 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_strong_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_strong_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_weak_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_weak_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_down_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_down_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_up_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_up_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_velocity_saturation_threshold") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_velocity_saturation_threshold) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_displacement_limiter") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_angular_displacement_limiter) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_angular_mandatory_axis") 
                        + " : [" 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_strong_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_strong_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_weak_acceleration_scale_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_weak_acceleration_scale_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_down_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_down_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_up_acceleration_rotation_from_reference") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_up_acceleration_rotation_from_reference) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_velocity_saturation_threshold") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_velocity_saturation_threshold) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_displacement_limiter") 
                        + " : [" 
                            + System.String.Join(",",this.phase_B_settings.secondary_linear_displacement_limiter) 
                        + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings.PhaseBSettings>("secondary_linear_mandatory_axis") 
                        + " : [" 
        ...
        public void AddUserLatencyToBucket(float new_latency)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : adding new latency["
                    + new_latency
                + "] to current bucket["
            ...
            if(this.m_currentInitialDefaultLatencyValueCount > 0)
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : removing last default value, remaining default count["
                        + this.m_currentInitialDefaultLatencyValueCount
                    + "]"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : new latency bucket ["
                    + System.String.Join(",",this.CurrentLatencyBucket)
                + "]"
            );
        ...
        protected override System.String getCurrentStatusInfo()
        {
            ...
            return (
                ...
                + " | "
                + this.downConditionCount
                + "(bas)/"
                + this.upConditionCount
                + "(haut)" 
            );
        ...
        public async override void onExperimentSessionBegin(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : begin"
            );
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : sync wait 5000.0ms for motion system init"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : will async fade in 1000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : async raise reset to initial position in 5000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : switch scene setup"
            );

            // deactivate default DB & activate room setup
            var we_behaviour
                = gameplay.ApollonGameplayManager.Instance.getConcreteBridge<
                    gameplay.element.ApollonWorldElementBridge
                >(
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : sync wait 5000.0ms init pause"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : end"
            );
        ...
        public override async void onExperimentSessionEnd(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionEnd() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentSessionEnd() : end"
            );
        ...
        public override async void onExperimentTrialBegin(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : begin"
            );
            ...
            gameplay.ApollonGameplayManager.Instance.setActive(gameplay.ApollonGameplayManager.GameplayIDType.AgencyAndThresholdPerceptionV4Control);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : trial protocol will start"
            );
            ...
            await this.DoRunProtocol(
                async () => {
                    await this.DoWhileLoop(
                        ...
                        async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4Phase0(this) ); },
                        async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseA(this) ); }
                    );
                },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseB(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseC(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseD(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseE(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV4PhaseF(this) ); },
                async () => { await this.SetState( null ); }
            );
            
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : end"
            );
        ...
        public override async void onExperimentTrialEnd(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentTrialEnd() : begin"
            );
            ...
            ApollonExperimentManager.Instance.Trial.result["user_randomized_stim_latency"] 
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Profile.onExperimentTrialEnd() : end"
            );
