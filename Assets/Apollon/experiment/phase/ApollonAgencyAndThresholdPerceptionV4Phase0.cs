...
namespace Labsim.apollon.experiment.phase
{
    ...
    //
    public sealed class ApollonAgencyAndThresholdPerceptionV4Phase0 
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV4Profile>
    {
        public ApollonAgencyAndThresholdPerceptionV4Phase0(profile.ApollonAgencyAndThresholdPerceptionV4Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : begin"
            );
            ...
            if (control_bridge == null || physical_motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : Could not find corresponding gameplay bridge !"
                );
            ...
            //     // void sync_local_function(object sender, gameplay.control.ApollonAgencyAndThresholdPerceptionV4ControlDispatcher.AgencyAndThresholdPerceptionV4ControlEventArgs e)
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : initial  stim"
            );
            ...
            >() {
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : raise virtual accel motion"
                        );
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : virtual motion idle state reached"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : raise physical accel motion"
                        );
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : physical motion idle state reached"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : will wait " 
                            + this.FSM.CurrentSettings.phase_0_settings.duration / 4.0f
                            + "ms before hiding green frame"
                        );
                        
                        // hide green frame at mid duration
                        await ApollonHighResolutionTime.DoSleep(this.FSM.CurrentSettings.phase_0_settings.duration / 4.0f);

                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : hide green frame"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : timeout, phase will end"
                        );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnExit() : end"
            );
        ...
        (
            gameplay.device.command.ApollonVirtualMotionSystemCommandBridge _bridge,
        ...
        (
            gameplay.device.command.ApollonMotionSystemCommandBridge _bridge,
            float[] _initial_angular_acceleration_target,
            float[] _initial_angular_velocity_saturation_threshold,
            float[] _initial_angular_displacement_limiter,
            float[] _initial_linear_acceleration_target,
