...
namespace Labsim.apollon.experiment.phase
{
    ...
    //
    public sealed class ApollonAgencyAndThresholdPerceptionV2PhaseB
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV2Profile>
    {
        public ApollonAgencyAndThresholdPerceptionV2PhaseB(profile.ApollonAgencyAndThresholdPerceptionV2Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : begin"
            );
            ...
            if(this.FSM.CurrentResults.phase_A_results.user_command == 1)
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : weak settings"
                );
            ...
            else if(this.FSM.CurrentResults.phase_A_results.user_command == 2)
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : strong settings"
                );
            ...
            else
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : unknown user_command... failed."
                );
            ...
            if (control_bridge == null || motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                // log
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : Could not find corresponding gameplay bridge !"
                );
            ...
            {            
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : beginning "
                ...
                await System.Threading.Tasks.Task.Factory.StartNew(
                        ...
                        { 
                            ...
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : waiting for idle state"
                            );
                    ...
                    // then sleep remaining idle time & raise end
                        ...
                        { 
                            ...
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : waiting [" 
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : reaching phase end"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseB.OnExit() : end"
            );
