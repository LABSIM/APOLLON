        ...
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV2Profile>
    {
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            if(this.FSM.CurrentResults.phase_A_results.user_command == 1)
            {
                ...
                // weak stim settings
                current_angular_acceleration_target            = this.FSM.CurrentSettings.phase_F_settings.angular_weak_acceleration_target;
                ...
                current_linear_acceleration_target             = this.FSM.CurrentSettings.phase_F_settings.linear_weak_acceleration_target;
            ...
            else if(this.FSM.CurrentResults.phase_A_results.user_command == 2)
            {
                ...
                current_angular_acceleration_target            = this.FSM.CurrentSettings.phase_F_settings.angular_strong_acceleration_target;
                ...
                current_linear_acceleration_target             = this.FSM.CurrentSettings.phase_F_settings.linear_strong_acceleration_target;
