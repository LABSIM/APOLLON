...
namespace Labsim.apollon.experiment.phase
{
        ...
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV2Profile>
    {
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV2PhaseF.OnEntry() : target {"
                + "[current_angular_acceleration_target:" 
                ...
                var phase_running_task
                    ...
                    // then sleep remaining idle time & raise end
                        ...
                        { 
                            ...
                            await ApollonHighResolutionTime.DoSleep(this.FSM.CurrentSettings.phase_F_settings.total_duration - ( 2.0f * this.FSM.CurrentSettings.phase_F_settings.stim_duration ));
