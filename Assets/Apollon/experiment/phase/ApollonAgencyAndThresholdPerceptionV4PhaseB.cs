...
namespace Labsim.apollon.experiment.phase
{
    ...
    //
    public sealed class ApollonAgencyAndThresholdPerceptionV4PhaseB
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV4Profile>
    {
        public ApollonAgencyAndThresholdPerceptionV4PhaseB(profile.ApollonAgencyAndThresholdPerceptionV4Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : begin"
            );
            ...
            var angular_acceleration_threshold_raw_string 
                = ApollonExperimentManager.Instance.Session.participantDetails["angular_acceleration_threshold"]
                .ToString();
            ...
            var linear_acceleration_threshold_raw_string 
                = ApollonExperimentManager.Instance.Session.participantDetails["linear_acceleration_threshold"]
                .ToString();
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : user reference {"
            ...
            if (control_bridge == null || physical_motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : Could not find corresponding gameplay bridge !"
                );
            ...
            // lambdas
            System.EventHandler<
                gameplay.device.command.ApollonVirtualMotionSystemCommandDispatcher.VirtualMotionSystemCommandEventArgs
            > sync_end_virtual_motion_local_function 
                = (sender, args) => sync_virtual_motion_idle_point?.TrySetResult(true);
            System.EventHandler<
                gameplay.device.command.ApollonMotionSystemCommandDispatcher.MotionSystemCommandEventArgs
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        if(remaining > 0.0f)
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : waiting [" 
                                + remaining 
                                + "ms] for end of phase"
                            );
                        ...
                        else
                        {
                            ...
                            UnityEngine.Debug.LogWarning(
                                "<color=Orange>Warn: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : strange... no remaing time to wait..."
                            );

                        } /* if() */

                        // wait end of phase 
                        await ApollonHighResolutionTime.DoSleep(remaining);
            ...
            switch(this.FSM.CurrentResults.phase_A_results.user_command)
            {
                ...
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Down:
                {
                    
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {

                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {

                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary down strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {

                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary down weak settings"
                            );
                        ...
                        default:
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {

                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary down reference settings"
                            );
                ...
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Up:
                {
                    ...
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary up strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary up weak settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary up reference settings"
                            );
                ...
                default:
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Reference:
                {
                    ...
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary reference strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary reference weak settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary reference reference settings"
                            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : primary target {"
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : primary stim"
            );
            ...
            if(this.FSM.CurrentSettings.phase_B_settings.SOA < 0.0f)
            {
                ...
                if(this.FSM.CurrentSettings.bIsTryCatch)
                {
                    ...
                    virtual_motion_system_bridge.ConcreteDispatcher.RaiseAccelerate(
                        ...
                        (
                            this.FSM.CurrentSettings.scenario_type == profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.ScenarioIDType.VisualOnly 
                            ? true 
                            : false
                        )
                    );
                ...
                parallel_tasks.Add(
                    parallel_tasks_factory.StartNew(
                        ...
                        { 
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : waiting for virtual motion idle state"
                            );
                ...
                parallel_tasks.Add(
                    parallel_tasks_factory.StartNew(
                        ...
                        { 
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : waiting for physical motion idle state"
                            );
                ...
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Down:
                {
                    ...
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary down strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary down weak settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary down reference settings"
                            );
                ...
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Up:
                {
                    ...
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary up strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary up weak settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary up reference settings"
                            );
                ...
                case (int)profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.SideIDType.Reference:
                {
                    ...
                    switch(this.FSM.CurrentSettings.passive_intensity_type)
                    {
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Strong:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary reference strong settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Weak:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary reference weak settings"
                            );
                        ...
                        case profile.ApollonAgencyAndThresholdPerceptionV4Profile.Settings.IntensityIDType.Reference:
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary reference reference settings"
                            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : secondary target {"
                + "[current_angular_acceleration_target:" 
                    + System.String.Join(",",current_angular_acceleration_target) 
                + "][current_angular_velocity_saturation_threshold:" 
                    + System.String.Join(",",current_angular_velocity_saturation_threshold) 
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : secondary stim"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4Phase0.OnEntry() : reaching phase end"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV4PhaseB.OnExit() : end"
            );
