// GENERATED AUTOMATICALLY FROM 'Assets/Inputs/AgencyAndThresholdPerceptionV3Control.inputactions'
...
{
    public class @ApollonAgencyAndThresholdPerceptionV3Control : IInputActionCollection, IDisposable
    {
        ...
        public struct SubjectActions
        {
            ...
            public void SetCallbacks(ISubjectActions instance)
            {
                if (m_Wrapper.m_SubjectActionsCallbackInterface != null)
                {
                    ...
                    @JoystickValueChanged.started -= m_Wrapper.m_SubjectActionsCallbackInterface.OnJoystickValueChanged;
                    @JoystickValueChanged.performed -= m_Wrapper.m_SubjectActionsCallbackInterface.OnJoystickValueChanged;
                    @JoystickValueChanged.canceled -= m_Wrapper.m_SubjectActionsCallbackInterface.OnJoystickValueChanged;
