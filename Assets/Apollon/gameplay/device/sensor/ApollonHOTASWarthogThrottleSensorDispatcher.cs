...
namespace Labsim.apollon.gameplay.device.sensor
{
    ...
    public class ApollonHOTASWarthogThrottleSensorDispatcher
    {
        ...
        // Constructor
        public ApollonHOTASWarthogThrottleSensorDispatcher()
        {
        ...
        } /* ApollonHOTASWarthogThrottleSensorDispatcher() */
    ...
    } /* class ApollonHOTASWarthogThrottleSensorDispatcher */
