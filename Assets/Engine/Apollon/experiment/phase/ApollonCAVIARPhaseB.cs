...
namespace Labsim.apollon.experiment.phase
{
        ...
        : ApollonAbstractExperimentState<profile.ApollonCAVIARProfile>
    {
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            // save timestamps
            this.FSM.CurrentResults.phase_B_results.timing_on_entry_host_timestamp = UXF.FileIOManager.CurrentHighResolutionTime;
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // save timestamps
            this.FSM.CurrentResults.phase_B_results.timing_on_exit_host_timestamp = UXF.FileIOManager.CurrentHighResolutionTime;
