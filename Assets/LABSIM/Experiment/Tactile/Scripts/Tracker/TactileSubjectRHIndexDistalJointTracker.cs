...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexDistalJointTracker
        : TactileAbstractTracker
    {

        //ctor
        public TactileSubjectRHIndexDistalJointTracker()
            : base()
        { }
        ...
        protected override UnityEngine.MonoBehaviour WrapBehaviour()
        {
            ...
            // retreive
            var behaviours = UnityEngine.Resources.FindObjectsOfTypeAll<TactileSubjectRHIndexDistalJointTrackerBehaviour>();
            if ((behaviours?.Length ?? 0) == 0)
            {

                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Orange>Warning: </color> TactileSubjectRHIndexDistalJointTracker.WrapBehaviour() : could not find object of type behaviour.TactileSubjectRHIndexDistalJointTrackerBehaviour from Unity."
                );
        ...
        {
            return TactileTrackerManager.IDType.TactileSubjectRHIndexDistalJoint;
        }
        ...
        protected override void SetActive(bool value)
        {
            ...
            else
            {
                ...
                if(!this.m_trackerTask.IsCompleted)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogWarning(
                        "<color=Orange>Warn: </color> TactileSubjectRHIndexDistalJointTracker.SetActive() : tracking task callback hasn't completed correctly... strange"
                    );
        ...
        private async void RecordRowTaskCallback()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTracker.OnRecordRowCoroutine() : begin"
            );
            ...
            while(!this.m_cancellationTokenSource.Token.IsCancellationRequested) 
            {
                ...
                var behaviour = this.Behaviour as TactileSubjectRHIndexDistalJointTrackerBehaviour;
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTracker.OnRecordRowCoroutine() : end"
            );
    ...
    } /* class TactileSubjectRHIndexDistalJointTracker */
