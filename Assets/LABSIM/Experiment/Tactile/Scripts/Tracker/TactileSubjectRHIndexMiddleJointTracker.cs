...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexMiddleJointTracker
        : TactileAbstractTracker
    {

        //ctor
        public TactileSubjectRHIndexMiddleJointTracker()
            : base()
        { }
        ...
        protected override UnityEngine.MonoBehaviour WrapBehaviour()
        {
            ...
            // retreive
            var behaviours = UnityEngine.Resources.FindObjectsOfTypeAll<TactileSubjectRHIndexMiddleJointTrackerBehaviour>();
            if ((behaviours?.Length ?? 0) == 0)
            {

                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Orange>Warning: </color> TactileSubjectRHIndexMiddleJointTracker.WrapBehaviour() : could not find object of type behaviour.TactileSubjectRHIndexMiddleJointTrackerBehaviour from Unity."
                );
        ...
        {
            return TactileTrackerManager.IDType.TactileSubjectRHIndexMiddleJoint;
        }
        ...
        protected override void SetActive(bool value)
        {
            ...
            else
            {
                ...
                if(!this.m_trackerTask.IsCompleted)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogWarning(
                        "<color=Orange>Warn: </color> TactileSubjectRHIndexMiddleJointTracker.SetActive() : tracking task callback hasn't completed correctly... strange"
                    );
        ...
        private async void RecordRowTaskCallback()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexMiddleJointTracker.OnRecordRowCoroutine() : begin"
            );
            ...
            while(!this.m_cancellationTokenSource.Token.IsCancellationRequested) 
            {
                ...
                var behaviour = this.Behaviour as TactileSubjectRHIndexMiddleJointTrackerBehaviour;
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexMiddleJointTracker.OnRecordRowCoroutine() : end"
            );
    ...
    } /* class TactileSubjectRHIndexMiddleJointTracker */
