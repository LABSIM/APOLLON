...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHWristTrackerBehaviour 
        : UXF.Tracker
    {
        ...
        // bridge
        public TactileSubjectRHWristTracker Tracker { get; set; }
        ...
        private void Initialize()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.Initialize() : begin");
            
            // todo

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.Initialize() : init ok, mark as initialized");
            
            // switch state
            this.m_bHasInitialized = true;

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.Initialize() : end");
        ...
        private void Close()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.Close() : begin");
   
            // todo
            
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.Close() : end");
        ...
        private void OnEnable()
        {
            ...
            if (!this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.OnEnable() : initialize required");
        ...
        private void OnDisable() 
        {
            ...
            if (this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHWristTrackerBehaviour.OnEnable() : close required");
    ...
    } /* class TactileSubjectRHWristTrackerBehaviour */
