...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexTipTracker
        : TactileAbstractTracker
    {

        //ctor
        public TactileSubjectRHIndexTipTracker()
            : base()
        { }
        ...
        protected override UnityEngine.MonoBehaviour WrapBehaviour()
        {
            ...
            // retreive
            var behaviours = UnityEngine.Resources.FindObjectsOfTypeAll<TactileSubjectRHIndexTipTrackerBehaviour>();
            if ((behaviours?.Length ?? 0) == 0)
            {

                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Orange>Warning: </color> TactileSubjectRHIndexTipTracker.WrapBehaviour() : could not find object of type behaviour.TactileSubjectRHIndexTipTrackerBehaviour from Unity."
                );
        ...
        {
            return TactileTrackerManager.IDType.TactileSubjectRHIndexTip;
        }
        ...
        protected override void SetActive(bool value)
        {
            ...
            else
            {
                ...
                if(!this.m_trackerTask.IsCompleted)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogWarning(
                        "<color=Orange>Warn: </color> TactileSubjectRHIndexTipTracker.SetActive() : tracking task callback hasn't completed correctly... strange"
                    );
        ...
        private async void RecordRowTaskCallback()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexTipTracker.OnRecordRowCoroutine() : begin"
            );
            ...
            while(!this.m_cancellationTokenSource.Token.IsCancellationRequested) 
            {
                ...
                var behaviour = this.Behaviour as TactileSubjectRHIndexTipTrackerBehaviour;
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexTipTracker.OnRecordRowCoroutine() : end"
            );
    ...
    } /* class TactileSubjectRHIndexTipTracker */
