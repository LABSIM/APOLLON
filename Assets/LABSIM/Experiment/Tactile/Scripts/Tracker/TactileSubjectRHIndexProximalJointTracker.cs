...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexProximalJointTracker
        : TactileAbstractTracker
    {

        //ctor
        public TactileSubjectRHIndexProximalJointTracker()
            : base()
        { }
        ...
        protected override UnityEngine.MonoBehaviour WrapBehaviour()
        {
            ...
            // retreive
            var behaviours = UnityEngine.Resources.FindObjectsOfTypeAll<TactileSubjectRHIndexProximalJointTrackerBehaviour>();
            if ((behaviours?.Length ?? 0) == 0)
            {

                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Orange>Warning: </color> TactileSubjectRHIndexProximalJointTracker.WrapBehaviour() : could not find object of type behaviour.TactileSubjectRHIndexProximalJointTrackerBehaviour from Unity."
                );
        ...
        {
            return TactileTrackerManager.IDType.TactileSubjectRHIndexProximalJoint;
        }
        ...
        protected override void SetActive(bool value)
        {
            ...
            else
            {
                ...
                if(!this.m_trackerTask.IsCompleted)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogWarning(
                        "<color=Orange>Warn: </color> TactileSubjectRHIndexProximalJointTracker.SetActive() : tracking task callback hasn't completed correctly... strange"
                    );
        ...
        private async void RecordRowTaskCallback()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTracker.OnRecordRowCoroutine() : begin"
            );
            ...
            while(!this.m_cancellationTokenSource.Token.IsCancellationRequested) 
            {
                ...
                var behaviour = this.Behaviour as TactileSubjectRHIndexProximalJointTrackerBehaviour;
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTracker.OnRecordRowCoroutine() : end"
            );
    ...
    } /* class TactileSubjectRHIndexProximalJointTracker */
