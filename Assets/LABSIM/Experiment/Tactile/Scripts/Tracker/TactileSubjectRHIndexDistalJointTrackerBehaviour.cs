...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexDistalJointTrackerBehaviour 
        : UXF.Tracker
    {
        ...
        // bridge
        public TactileSubjectRHIndexDistalJointTracker Tracker { get; set; }
        ...
        private void Initialize()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.Initialize() : begin");
            
            // todo

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.Initialize() : init ok, mark as initialized");
            
            // switch state
            this.m_bHasInitialized = true;

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.Initialize() : end");
        ...
        private void Close()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.Close() : begin");
   
            // todo
            
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.Close() : end");
        ...
        private void OnEnable()
        {
            ...
            if (!this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.OnEnable() : initialize required");
        ...
        private void OnDisable() 
        {
            ...
            if (this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexDistalJointTrackerBehaviour.OnEnable() : close required");
    ...
    } /* class TactileSubjectRHIndexDistalJointTrackerBehaviour */
