...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexTipTrackerBehaviour 
        : UXF.Tracker
    {
        ...
        // bridge
        public TactileSubjectRHIndexTipTracker Tracker { get; set; }
        ...
        private void Initialize()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.Initialize() : begin");
            
            // todo

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.Initialize() : init ok, mark as initialized");
            
            // switch state
            this.m_bHasInitialized = true;

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.Initialize() : end");
        ...
        private void Close()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.Close() : begin");
   
            // todo
            
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.Close() : end");
        ...
        private void OnEnable()
        {
            ...
            if (!this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.OnEnable() : initialize required");
        ...
        private void OnDisable() 
        {
            ...
            if (this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexTipTrackerBehaviour.OnEnable() : close required");
    ...
    } /* class TactileSubjectRHIndexTipTrackerBehaviour */
