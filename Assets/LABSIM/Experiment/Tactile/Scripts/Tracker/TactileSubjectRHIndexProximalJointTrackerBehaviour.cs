...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileSubjectRHIndexProximalJointTrackerBehaviour 
        : UXF.Tracker
    {
        ...
        // bridge
        public TactileSubjectRHIndexProximalJointTracker Tracker { get; set; }
        ...
        private void Initialize()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.Initialize() : begin");
            
            // todo

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.Initialize() : init ok, mark as initialized");
            
            // switch state
            this.m_bHasInitialized = true;

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.Initialize() : end");
        ...
        private void Close()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.Close() : begin");
   
            // todo
            
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.Close() : end");
        ...
        private void OnEnable()
        {
            ...
            if (!this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.OnEnable() : initialize required");
        ...
        private void OnDisable() 
        {
            ...
            if (this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> TactileSubjectRHIndexProximalJointTrackerBehaviour.OnEnable() : close required");
    ...
    } /* class TactileSubjectRHIndexProximalJointTrackerBehaviour */
