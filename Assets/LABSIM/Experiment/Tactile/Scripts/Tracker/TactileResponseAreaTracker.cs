...
namespace Labsim.experiment.tactile
{
    ...
    public sealed class TactileResponseAreaTracker
        : TactileAbstractTracker
    {

        //ctor
        public TactileResponseAreaTracker()
            : base()
        { }
        ...
        protected override UnityEngine.MonoBehaviour WrapBehaviour()
        {
            ...
            // retreive
            var behaviours = UnityEngine.Resources.FindObjectsOfTypeAll<TactileResponseAreaTrackerBehaviour>();
            if ((behaviours?.Length ?? 0) == 0)
            {

                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Orange>Warning: </color> TactileResponseAreaTracker.WrapBehaviour() : could not find object of type behaviour.TactileResponseAreaTrackerBehaviour from Unity."
                );
        ...
        {
            return TactileTrackerManager.IDType.TactileResponseArea;
        }
        ...
        protected override void SetActive(bool value)
        {
            ...
            else
            {
                ...
                if(!this.m_trackerTask.IsCompleted)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogWarning(
                        "<color=Orange>Warn: </color> TactileResponseAreaTracker.SetActive() : tracking task callback hasn't completed correctly... strange"
                    );
        ...
        private async void RecordRowTaskCallback()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileResponseAreaTracker.OnRecordRowCoroutine() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> TactileResponseAreaTracker.OnRecordRowCoroutine() : end"
            );
    ...
    } /* class TactileResponseAreaTracker */
