...
namespace Labsim.apollon.io.file
{
    ...
    public class ApollonRecordFileFacade
    {
        // Ctor
        public ApollonRecordFileFacade(datamodel.ApollonRecordFileImpl impl)
        {
        ...
        private datamodel.ApollonRecordFileImpl m_impl = null;
        public datamodel.ApollonRecordFileImpl Implementation
        {
            get
            {
                return this.m_impl;
        ...
        public void Commit()
        {
            ...
            foreach (System.Reflection.FieldInfo field in this.Implementation.GetType().GetFields())
            {
                ...
                this.Implementation = (datamodel.ApollonRecordFileImpl)boxedObject;
