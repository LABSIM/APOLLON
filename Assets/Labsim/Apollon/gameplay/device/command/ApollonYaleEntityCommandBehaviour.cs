...
namespace Labsim.apollon.gameplay.device.command
{
    ...
    public class ApollonYaleEntityCommandBehaviour
        : ApollonConcreteGameplayBehaviour<ApollonYaleEntityCommandBridge>
    {
        ...
        {
            private ApollonYaleEntityCommandBehaviour _parent = null;
            ...
            private void OnEnable() 
            {
                ...
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : begin"
                );

                // preliminary
                if ((this._parent = this.GetComponentInParent<ApollonYaleEntityCommandBehaviour>()) == null
                ...
                )
                {
                    ...
                    UnityEngine.Debug.LogError(
                        "<color=Red>Error: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : failed to get parent/rigidbody reference ! Self disabling..."
                    );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : rigidbody initialized"
                );
                ...
                if (!float.TryParse(experiment.ApollonExperimentManager.Instance.Session.participantDetails["PoV_height_offset"].ToString(), out PoV_height_offset)
                    ...
                    UnityEngine.Debug.LogWarning(
                        "<color=Yellow>Warning: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : failed to get current participant PoV_offset, setup PoV_offset (height,depth) to default value [ "
                        + PoV_height_offset 
                        + ","
                        + PoV_depth_offset
                        + " ]"
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : rigidbody configured with current user settings, going idle state"
                );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.InitController.OnEnable() : end"
                );
            ...
            : UnityEngine.MonoBehaviour
        {
            ...
            private void OnEnable()
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.IdleController.OnEnable() : begin"
                );
                ...
                )
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Error: </color> ApollonYaleEntityCommandBehaviour.IdleController.OnEnable() : failed to get parent reference ! Self disabling..."
                    );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.IdleController.OnEnable() : end"
                );
            ...
            private void OnDisable()
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.IdleController.OnDisable() : begin"
                );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.IdleController.OnDisable() : end"
                );
            ...
            : UnityEngine.MonoBehaviour
        {
            ...
            private void OnEnable()
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.AccelerateController.OnEnable() : begin"
                );
                ...
                )
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Error: </color> ApollonYaleEntityCommandBehaviour.AccelerateController.OnEnable() : failed to get parent/rigidbody reference ! Self disabling..."
                    );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.AccelerateController.OnEnable() : end"
                );
            ...
            private void FixedUpdate()
            {
                ...
                //     // log
                //     UnityEngine.Debug.Log(
                //         "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.AccelerateController.FixedUpdate() : angular & linear saturation velocity reached, raise saturation event"
                //     );
                ...
                //     // log
                //     UnityEngine.Debug.Log(
                //         "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.AccelerateController.FixedUpdate() : stimulation duration/angle reached, raise deceleration event"
                //     );
            ...
            : UnityEngine.MonoBehaviour
        {
            ...
            private void OnEnable()
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.ResetController.OnEnable() : begin"
                );
                ...
                )
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Error: </color> ApollonYaleEntityCommandBehaviour.ResetController.OnEnable() : failed to get parent/rigidbody reference ! Self disabling..."
                    );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.ResetController.OnEnable() : end"
                );
            ...
            private void FixedUpdate()
            {
                ...
                if(this._bEnd)
                {
                    ...
                    // log
                    UnityEngine.Debug.Log(
                        "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.ResetController.FixedUpdate() : reset reached, doing re-init procedure"
                    );
        ...
        private void Initialize()
        {
            ...
            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.Initialize() : begin");
            ...
            UnityEngine.Debug.Log("<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.Initialize() : state controller added as gameObject's component, mark as initialized");

            // switch state
            this.m_bHasInitialized = true;

            // log
            UnityEngine.Debug.Log("<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.Initialize() : end");
        ...
        void OnEnable()
        {
            ...
            if (!this.m_bHasInitialized)
            {
                ...
                // log
                UnityEngine.Debug.Log("<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.OnEnable() : initialize recquired");
            ...
            if (!float.TryParse(experiment.ApollonExperimentManager.Instance.Session.participantDetails["mass"].ToString(), out user_mass))
            {
                ...
                // log
                UnityEngine.Debug.LogWarning(
                    "<color=Yellow>Warning: </color> ApollonYaleEntityCommandBehaviour.OnEnable() : failed to get current participant mass detail, setup mass to default value [ "
                    + user_mass
                    + " ]"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonYaleEntityCommandBehaviour.OnEnable() : added participant mass detail to simulated setup, total mass value is [ "
