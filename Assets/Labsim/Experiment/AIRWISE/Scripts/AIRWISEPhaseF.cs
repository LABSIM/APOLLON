...
namespace Labsim.experiment.AIRWISE
{
    ...
    //
    // Question : Physical demand - FSM state
    //
    public sealed class AIRWISEPhaseF 
        : apollon.experiment.ApollonAbstractExperimentState<AIRWISEProfile>
    {
        public AIRWISEPhaseF(AIRWISEProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseF.OnEntry() : begin"
            );
            ...
            // update instructions 
            this.FSM.CurrentInstruction = "Charge physique ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.PhysicalDemandSliderGUI);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseF.OnEntry() : final [Physical demand] result {"  
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseF.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseF.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseF.OnExit() : end"
            );
