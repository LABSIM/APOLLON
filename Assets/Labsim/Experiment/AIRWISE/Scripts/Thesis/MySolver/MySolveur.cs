...
//     private double tnNext;

//     public List<Vector4> Y = new List<Vector4>();
//     public List<double> t = new List<double>();

//     private Func<double, Vector4, Vector4> function;

//     public RungeKutta_Explicite(int order, Func<double, Vector4, Vector4> function, double dt, double tSolver)
//     {
//         this.order = order;
...
//     public void Reset(double t0, Vector4 X0)
//     {
...
//         {
//             //Je r�souds mon �uqua diff
//             //Toujours d�cr&menter plut�t qu'incr�menter
//         }
