...
//     public void Initialize(double t0, double tf, Vector4 X0, float vNorm)
//     {
//         //this.t0 = t0;
//         //this.tf = tf;
...
//     public Vector4 GetResolutionResultAtTime(double t)
//     {
//         try
//         {
//             float tSolver = (float)t - this.m_RK.t0;
...
//     public Vector3 GetResolutionPositionAtTime(double t)
//     {
//         Vector4 res = this.GetResolutionResultAtTime((float) t);
//         return new Vector3(res.z, res.w, AeroFrame.GetPosition(this.rb).z);
//     }

//     public Vector4 FajenDynamics(double tn, Vector4 X)
//     {
