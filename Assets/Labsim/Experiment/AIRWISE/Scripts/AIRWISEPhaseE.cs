...
namespace Labsim.experiment.AIRWISE
{
    ...
    //
    // Question : Mental demand - FSM state
    //
    public sealed class AIRWISEPhaseE 
        : apollon.experiment.ApollonAbstractExperimentState<AIRWISEProfile>
    {
        public AIRWISEPhaseE(AIRWISEProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseE.OnEntry() : begin"
            );
            ...
            // update instructions 
            this.FSM.CurrentInstruction = "Charge mentale ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.MentalDemandSliderGUI);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseE.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseE.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseE.OnExit() : end"
            );
