...
namespace Labsim.experiment.AIRWISE
{
    ...
    //
    // Question : Frustration - FSM state
    //
    public sealed class AIRWISEPhaseJ 
        : apollon.experiment.ApollonAbstractExperimentState<AIRWISEProfile>
    {
        public AIRWISEPhaseJ(AIRWISEProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseJ.OnEntry() : begin"
            );
                ...
                = (sender, args) => { 
                    ...
                    sync_point?.TrySetResult((
                        ...
                        apollon.frontend.ApollonFrontendManager.Instance.getBridge(
                            apollon.frontend.ApollonFrontendManager.FrontendIDType.FrustrationSliderGUI
            ...
            // update instructions 
            this.FSM.CurrentInstruction = "Frustration ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.FrustrationSliderGUI);
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.FrustrationSliderGUI);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseJ.OnEntry() : final [Frustration] result {"  
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseJ.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseJ.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseJ.OnExit() : end"
            );
