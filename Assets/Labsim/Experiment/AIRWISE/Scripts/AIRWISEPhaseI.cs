...
namespace Labsim.experiment.AIRWISE
{
    ...
    //
    // Question : Effort - FSM state
    //
    public sealed class AIRWISEPhaseI 
        : apollon.experiment.ApollonAbstractExperimentState<AIRWISEProfile>
    {
        public AIRWISEPhaseI(AIRWISEProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseI.OnEntry() : begin"
            );
                ...
                = (sender, args) => { 
                    ...
                    sync_point?.TrySetResult((
                        ...
                        apollon.frontend.ApollonFrontendManager.Instance.getBridge(
                            apollon.frontend.ApollonFrontendManager.FrontendIDType.EffortSliderGUI
            ...
            // update instructions 
            this.FSM.CurrentInstruction = "Effort ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.EffortSliderGUI);
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.EffortSliderGUI);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseI.OnEntry() : final [Effort] result {"  
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseI.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseI.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AIRWISEPhaseI.OnExit() : end"
            );
