...
namespace Labsim.experiment.AgencyAndThresholdPerceptionV4
{
    ...
    public class AgencyAndThresholdPerceptionV4Profile 
        : apollon.experiment.ApollonAbstractExperimentFiniteStateMachine< AgencyAndThresholdPerceptionV4Profile >
    {

        // Ctor
        public AgencyAndThresholdPerceptionV4Profile()
            : base()
        {
            // default profile
            this.m_profileID = apollon.experiment.ApollonExperimentManager.ProfileIDType.AgencyAndThresholdPerceptionV4;
        }
        ...
        public class Settings
        {
            ...
            private string GetJSONSettingsAttributeName<T>(string field_name)
            {
                ...
                catch(System.Exception ex)
                {
                    ...
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> AgencyAndThresholdPerceptionV4Profile.Settings.GetJSONSettingsAttributeName() : failed to extract ("
                        + field_name
                        + ") with error ["
                        + ex.Message
                        + "]"
            ...
            public bool ImportUXFSettings(UXF.Settings settings)
            {
                ...
                try
                {
                    ...
                    switch(
                        ...
                        // Left
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.SideIDType.Left),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                        ...
                        // Right
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.SideIDType.Right),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                        ...
                        // Up
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.SideIDType.Up),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                        ...
                        // Down
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.SideIDType.Down),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                    ...
                    switch(
                        ...
                        // linear
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.FogIDType.Linear),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                        ...
                        // exp
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.FogIDType.Exponential),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                        ...
                        // exp2
                        case string param when param.Equals(
                            apollon.ApollonEngine.GetEnumDescription(Settings.FogIDType.ExponentialSquared),
                            System.StringComparison.InvariantCultureIgnoreCase
                        ) : {
                ...
                catch(System.Exception ex)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> AgencyAndThresholdPerceptionV4Profile.Settings.ImportUXFSettings() : failed to import settings with error ["
                        + ex.Message
                        + "]"
                    );
            ...
            public void LogUXFSettings()
            {
                ...
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.Settings.LogUXFSettings() : imported current settings with pattern["
                        + this.pattern_type
                    + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("bIsTryCatch") 
                    ...
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("passive_side_type") 
                        + " : " 
                        + apollon.ApollonEngine.GetEnumDescription(this.passive_side_type)
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("bWithVisualDegradation") 
                        + " : " 
                        + this.bWithVisualDegradation
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("fog_type") 
                        + " : " 
                        + apollon.ApollonEngine.GetEnumDescription(this.fog_type)
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("fog_color") 
                        + " : [" 
        ...
        public void AddUserLatencyToBucket(float new_latency)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : adding new latency["
                    + new_latency
                + "] to current bucket["
            ...
            if(this.m_currentInitialDefaultLatencyValueCount > 0)
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : removing last default value, remaining default count["
                        + this.m_currentInitialDefaultLatencyValueCount
                    + "]"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.AddUserLatencyToBucket() : new latency bucket ["
                    + System.String.Join(",",this.CurrentLatencyBucket)
                + "]"
            );
        ...
        public async override void onExperimentSessionBegin(object sender, apollon.ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : begin"
            );
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : sync wait 5000.0ms for motion system init"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : will async fade in 1000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : async raise reset to initial position in 5000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : switch scene setup"
            );

            // deactivate default DB & activate room setup
            var we_behaviour
                = apollon.gameplay.ApollonGameplayManager.Instance.getConcreteBridge<
                    apollon.gameplay.element.ApollonWorldElementBridge
                >(
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : sync wait 5000.0ms init pause"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionBegin() : end"
            );
        ...
        public override async void onExperimentSessionEnd(object sender, apollon.ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionEnd() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentSessionEnd() : end"
            );
        ...
        public override async void onExperimentTrialBegin(object sender, apollon.ApollonEngine.EngineExperimentEventArgs arg)
        {
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : trial protocol will start"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentTrialBegin() : end"
            );
        ...
        public override async void onExperimentTrialEnd(object sender, apollon.ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentTrialEnd() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV4Profile.onExperimentTrialEnd() : end"
            );
