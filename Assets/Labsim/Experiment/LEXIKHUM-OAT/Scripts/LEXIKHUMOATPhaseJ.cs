...
namespace Labsim.experiment.LEXIKHUM_OAT
{
    ...
    public sealed class LEXIKHUMOATPhaseJ 
        : apollon.experiment.ApollonAbstractExperimentState<LEXIKHUMOATProfile>
    {
        public LEXIKHUMOATPhaseJ(LEXIKHUMOATProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseJ.OnEntry() : begin"
            );
                ...
                = (sender, args) => { 
                    ...
                    sync_point?.TrySetResult((
                        ...
                        apollon.frontend.ApollonFrontendManager.Instance.getBridge(
                            apollon.frontend.ApollonFrontendManager.FrontendIDType.Question07GUI
            ...
            // update instructions 
            this.FSM.CurrentQuestion               = "La collaboration entre moi et l'agent autonome a été efficace pour résoudre la situation ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question07GUI);
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question07GUI);
            ...
            this.FSM.CurrentResults.PhaseJ.user_elapsed_ms_since_entry          = result.Item4;
            
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseJ.OnEntry() : final result {"  
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseJ.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseJ.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseJ.OnExit() : end"
            );
