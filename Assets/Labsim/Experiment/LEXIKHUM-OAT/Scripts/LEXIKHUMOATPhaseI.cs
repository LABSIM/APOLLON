...
namespace Labsim.experiment.LEXIKHUM_OAT
{
        ...
        : apollon.experiment.ApollonAbstractExperimentState<LEXIKHUMOATProfile>
    {
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            // update instructions 
            this.FSM.CurrentQuestion               = "Le systeme a été un membre utile de l'equipe pendant la resolution de la situation ?";
            ...
            this.FSM.CurrentResults.PhaseI.user_elapsed_ms_since_entry          = result.Item4;
            ...
            UnityEngine.Debug.Log(
                ...
                // + "/varjo timestamp["         + this.FSM.CurrentResults.PhaseI.user_response_timing_varjo_timestamp + "]"
