...
namespace Labsim.experiment.LEXIKHUM_OAT
{
    ...
    public sealed class LEXIKHUMOATPhaseF 
        : apollon.experiment.ApollonAbstractExperimentState<LEXIKHUMOATProfile>
    {
        public LEXIKHUMOATPhaseF(LEXIKHUMOATProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseF.OnEntry() : begin"
            );

            // save timestamps
            this.FSM.CurrentResults.PhaseF.timing_on_entry_host_timestamp  = apollon.ApollonHighResolutionTime.Now.ToString();
            // this.FSM.CurrentResults.PhaseF.timing_on_entry_varjo_timestamp = Varjo.XR.VarjoTime.GetVarjoTimestamp();
            this.FSM.CurrentResults.PhaseF.timing_on_entry_unity_timestamp = UnityEngine.Time.time;
                ...
                = (sender, args) => { 
                    ...
                    sync_point?.TrySetResult((
                        ...
                        apollon.frontend.ApollonFrontendManager.Instance.getBridge(
                            apollon.frontend.ApollonFrontendManager.FrontendIDType.Question02GUI
            ...
            // update instructions 
            this.FSM.CurrentQuestion               = "Degré de contrôle ressenti lors de la tâche ?";
            this.FSM.CurrentQuestionDetail         = "";
            this.FSM.CurrentQuestionTickLowerBound = "pas du tout";
            this.FSM.CurrentQuestionTickUpperBound = "beaucoup";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question02GUI);
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question02GUI);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseF.OnEntry() : final result {"  
                + "user responded["          + this.FSM.CurrentResults.PhaseF.user_response_value                  + "]"
                + "/unity render timestamp[" + this.FSM.CurrentResults.PhaseF.user_response_timing_unity_timestamp + "]"
                + "/host timestamp["         + this.FSM.CurrentResults.PhaseF.user_response_timing_host_timestamp  + "]"
                // + "/varjo timestamp["         + this.FSM.CurrentResults.PhaseF.user_response_timing_varjo_timestamp + "]"
                + "/current timestamp["      + this.FSM.CurrentResults.PhaseF.user_elapsed_ms_since_entry          + "]"
                + "}"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseF.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseF.OnExit() : begin"
            );
            
            // save timestamps
            this.FSM.CurrentResults.PhaseF.timing_on_exit_host_timestamp  = apollon.ApollonHighResolutionTime.Now.ToString();
            // this.FSM.CurrentResults.PhaseF.timing_on_exit_varjo_timestamp = Varjo.XR.VarjoTime.GetVarjoTimestamp();
            this.FSM.CurrentResults.PhaseF.timing_on_exit_unity_timestamp = UnityEngine.Time.time;

            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseF.OnExit() : end"
            );
