...
namespace Labsim.experiment.LEXIKHUM_OAT
{
    ...
    public sealed class LEXIKHUMOATPhaseG 
        : apollon.experiment.ApollonAbstractExperimentState<LEXIKHUMOATProfile>
    {
        public LEXIKHUMOATPhaseG(LEXIKHUMOATProfile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseG.OnEntry() : begin"
            );
                ...
                = (sender, args) => { 
                    ...
                    sync_point?.TrySetResult((
                        ...
                        apollon.frontend.ApollonFrontendManager.Instance.getBridge(
                            apollon.frontend.ApollonFrontendManager.FrontendIDType.Question03GUI
            ...
            // update instructions 
            this.FSM.CurrentQuestion               = "Utiliseriez-vous à nouveau le système pour une tâche similaire ?";
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setActive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question03GUI);
            ...
            apollon.frontend.ApollonFrontendManager.Instance.setInactive(apollon.frontend.ApollonFrontendManager.FrontendIDType.Question03GUI);
            ...
            this.FSM.CurrentResults.PhaseG.user_elapsed_ms_since_entry          = result.Item4;
            
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseG.OnEntry() : final result {"  
                ...
                // + "/varjo timestamp["         + this.FSM.CurrentResults.PhaseG.user_response_timing_varjo_timestamp + "]"
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseG.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseG.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> LEXIKHUMOATPhaseG.OnExit() : end"
            );
