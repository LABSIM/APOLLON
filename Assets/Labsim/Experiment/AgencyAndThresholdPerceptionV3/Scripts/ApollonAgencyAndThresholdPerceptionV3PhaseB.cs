...
namespace Labsim.apollon.experiment.phase
{
    ...
    //
    public sealed class ApollonAgencyAndThresholdPerceptionV3PhaseB
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV3Profile>
    {
        public ApollonAgencyAndThresholdPerceptionV3PhaseB(profile.ApollonAgencyAndThresholdPerceptionV3Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : user reference {"
            ...
            if (control_bridge == null || physical_motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : Could not find corresponding gameplay bridge !"
                );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        if(remaining > 0.0f)
                        {
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : waiting [" 
                                + remaining 
                                + "ms] for end of phase"
                            );
                        ...
                        else
                        {
                            ...
                            UnityEngine.Debug.LogWarning(
                                "<color=Orange>Warn: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : strange... no remaing time to wait..."
                            );
            ...
            if(
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : primary weak settings"
                );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : primary strong settings"
                );
            ...
            else
            {
                ...
                // log 
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : unknown user_command... failed."
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : primary target {"
                + "[current_angular_acceleration_target:" 
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : primary stim"
            );
            ...
            if(this.FSM.CurrentSettings.phase_B_settings.SOA < 0.0f)
            {
                ...
                if(this.FSM.CurrentSettings.bIsTryCatch)
                {
                    ...
                    virtual_motion_system_bridge.ConcreteDispatcher.RaiseAccelerate(
                        ...
                        (
                            this.FSM.CurrentSettings.scenario_type == profile.ApollonAgencyAndThresholdPerceptionV3Profile.Settings.ScenarioIDType.VisualOnly 
                            ? true 
                            : false
                        )
                    );
                ...
                parallel_tasks.Add(
                    parallel_tasks_factory.StartNew(
                        ...
                        { 
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : waiting for virtual motion idle state"
                            );
                ...
                parallel_tasks.Add(
                    parallel_tasks_factory.StartNew(
                        ...
                        { 
                            ...
                            // log
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : waiting for physical motion idle state"
                            );
            ...
            if(
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : secondary weak settings"
                );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : secondary strong settings"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : secondary target {"
                + "[current_angular_acceleration_target:" 
                    + System.String.Join(",",current_angular_acceleration_target) 
                + "][current_angular_velocity_saturation_threshold:" 
                    + System.String.Join(",",current_angular_velocity_saturation_threshold) 
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : secondary stim"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : reaching phase end"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3PhaseB.OnExit() : end"
            );
