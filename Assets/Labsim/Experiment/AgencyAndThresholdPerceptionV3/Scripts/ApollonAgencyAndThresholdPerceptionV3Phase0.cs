...
namespace Labsim.apollon.experiment.phase
{
    ...
    //
    public sealed class ApollonAgencyAndThresholdPerceptionV3Phase0 
        : ApollonAbstractExperimentState<profile.ApollonAgencyAndThresholdPerceptionV3Profile>
    {
        public ApollonAgencyAndThresholdPerceptionV3Phase0(profile.ApollonAgencyAndThresholdPerceptionV3Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : begin"
            );
            ...
            if (control_bridge == null || physical_motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : Could not find corresponding gameplay bridge !"
                );
            ...
            if (this.FSM.CurrentSettings.bIsActive)
            {
                ...
                // synchronisation mechanism (TCS + local function)
                void sync_local_function(object sender, gameplay.control.ApollonAgencyAndThresholdPerceptionV3ControlDispatcher.AgencyAndThresholdPerceptionV3ControlEventArgs e)
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : initial  stim"
            );
            ...
            >() {
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : raise virtual accel motion"
                        );
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : virtual motion idle state reached"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : raise physical accel motion"
                        );
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : physical motion idle state reached"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : will wait " 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : hide green frame"
                        );
                ...
                parallel_tasks_factory.StartNew(
                    ...
                    { 
                        ...
                        UnityEngine.Debug.Log(
                            "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : timeout, phase will end"
                        );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Phase0.OnExit() : end"
            );
