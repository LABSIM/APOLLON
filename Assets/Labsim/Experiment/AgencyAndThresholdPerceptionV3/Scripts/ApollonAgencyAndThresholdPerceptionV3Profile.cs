...
namespace Labsim.apollon.experiment.profile
{
    ...
    public class ApollonAgencyAndThresholdPerceptionV3Profile 
        : ApollonAbstractExperimentFiniteStateMachine< ApollonAgencyAndThresholdPerceptionV3Profile >
    {

        // Ctor
        public ApollonAgencyAndThresholdPerceptionV3Profile()
            : base()
        {
            // default profile
            this.m_profileID = ApollonExperimentManager.ProfileIDType.AgencyAndThresholdPerceptionV3;
        }
        ...
        public class Settings
        {
            ...
            private string GetJSONSettingsAttributeName<T>(string field_name)
            {
                ...
                catch(System.Exception ex)
                {
                    ...
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.Settings.GetJSONSettingsAttributeName() : failed to extract ("
                        + field_name
                        + ") with error ["
                        + ex.Message
                        + "]"
            ...
            public bool ImportUXFSettings(UXF.Settings settings)
            {
                ...
                catch(System.Exception ex)
                {
                    ...
                    // log
                    UnityEngine.Debug.LogError(
                        "<color=Red>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.Settings.ImportUXFSettings() : failed to import settings with error ["
                        + ex.Message
                        + "]"
                    );
            ...
            public void LogUXFSettings()
            {
                ...
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.Settings.LogUXFSettings() : imported current settings with pattern["
                        + this.pattern_type
                    + "]"
                    + "\n - " 
                        + this.GetJSONSettingsAttributeName<Settings>("bIsTryCatch") 
        ...
        public void AddUserLatencyToBucket(float new_latency)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.AddUserLatencyToBucket() : adding new latency["
                    + new_latency
                + "] to current bucket["
            ...
            if(this.m_currentInitialDefaultLatencyValueCount > 0)
            {
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.AddUserLatencyToBucket() : removing last default value, remaining default count["
                        + this.m_currentInitialDefaultLatencyValueCount
                    + "]"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.AddUserLatencyToBucket() : new latency bucket ["
                    + System.String.Join(",",this.CurrentLatencyBucket)
                + "]"
            );
        ...
        public async override void onExperimentSessionBegin(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : begin"
            );
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : sync wait 5000.0ms for motion system init"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : will async fade in 1000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : async raise reset to initial position in 5000.0ms"
            );
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : switch scene setup"
            );
            ...
            // log 
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : sync wait 5000.0ms init pause"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionBegin() : end"
            );
        ...
        public override async void onExperimentSessionEnd(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionEnd() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentSessionEnd() : end"
            );
        ...
        public override async void onExperimentTrialBegin(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentTrialBegin() : begin"
            );
            ...
            gameplay.ApollonGameplayManager.Instance.setActive(gameplay.ApollonGameplayManager.GameplayIDType.AgencyAndThresholdPerceptionV3Control);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentTrialBegin() : trial protocol will start"
            );
            ...
            await this.DoRunProtocol(
                async () => {
                    await this.DoWhileLoop(
                        ...
                        async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3Phase0(this) ); },
                        async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseA(this) ); }
                    );
                },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseB(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseC(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseD(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseE(this) ); },
                async () => { await this.SetState( new phase.ApollonAgencyAndThresholdPerceptionV3PhaseF(this) ); },
                async () => { await this.SetState( null ); }
            );
            
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentTrialBegin() : end"
            );
        ...
        public override async void onExperimentTrialEnd(object sender, ApollonEngine.EngineExperimentEventArgs arg)
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentTrialEnd() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> ApollonAgencyAndThresholdPerceptionV3Profile.onExperimentTrialEnd() : end"
            );
