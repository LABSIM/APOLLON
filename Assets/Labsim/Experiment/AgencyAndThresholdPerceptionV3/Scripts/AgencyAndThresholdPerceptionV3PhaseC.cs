...
namespace Labsim.experiment.AgencyAndThresholdPerceptionV3
{
    ...
    //
    public sealed class AgencyAndThresholdPerceptionV3PhaseC
        : apollon.experiment.ApollonAbstractExperimentState<AgencyAndThresholdPerceptionV3Profile>
    {
        public AgencyAndThresholdPerceptionV3PhaseC(AgencyAndThresholdPerceptionV3Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV3PhaseC.OnEntry() : begin"
            );
            ...
            if (physical_motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> AgencyAndThresholdPerceptionV3PhaseC.OnEntry() : Could not find corresponding gameplay bridge !"
                );
            ...
            await apollon.ApollonHighResolutionTime.DoSleep(this.FSM.CurrentSettings.phase_C_settings.duration);
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV3PhaseC.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV3PhaseC.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV3PhaseC.OnExit() : end"
            );
