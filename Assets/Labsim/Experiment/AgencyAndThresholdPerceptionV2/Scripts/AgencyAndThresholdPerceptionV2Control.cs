...
//     version 1.7.0
//     from Assets/Labsim/Experiment/AgencyAndThresholdPerceptionV2/Inputs/AgencyAndThresholdPerceptionV2Control.inputactions
//
...
{
    public partial class @AgencyAndThresholdPerceptionV2Control: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @AgencyAndThresholdPerceptionV2Control()
        {
    ...
    ""controlSchemes"": [
        ...
        {
            private @AgencyAndThresholdPerceptionV2Control m_Wrapper;
            public SubjectActions(@AgencyAndThresholdPerceptionV2Control wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @AgencyAndThresholdPerceptionV2Control m_Wrapper;
            public SupervisorActions(@AgencyAndThresholdPerceptionV2Control wrapper) { m_Wrapper = wrapper; }
