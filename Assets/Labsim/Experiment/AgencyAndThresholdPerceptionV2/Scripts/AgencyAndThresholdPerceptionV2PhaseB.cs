...
namespace Labsim.experiment.AgencyAndThresholdPerceptionV2
{
    ...
    //
    public sealed class AgencyAndThresholdPerceptionV2PhaseB
        : apollon.experiment.ApollonAbstractExperimentState<AgencyAndThresholdPerceptionV2Profile>
    {
        public AgencyAndThresholdPerceptionV2PhaseB(AgencyAndThresholdPerceptionV2Profile fsm)
            : base(fsm)
        {
        }
        ...
        public async override System.Threading.Tasks.Task OnEntry()
        {
            ...
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : user reference {"
            ...
            if(
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : weak settings"
                );
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : strong settings"
                );
            ...
            else
            {
                ...
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : unknown user_command... failed."
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : target {"
                + "[current_angular_acceleration_target:" 
            ...
            if (control_bridge == null || motion_system_bridge == null || virtual_motion_system_bridge == null)
            {
                ...
                // log
                UnityEngine.Debug.LogError(
                    "<color=Red>Error: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : Could not find corresponding gameplay bridge !"
                );
                ...
                if(saturation_item == 0.0f)
                {
                    current_angular_velocity_saturation_threshold[index] 
                        = (
                            ...
                            * ( this.FSM.CurrentSettings.phase_B_settings.stim_duration / 1000.0f )
                        );
                }
            }
            ...
            {            
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : beginning "
                    ...
                    virtual_motion_system_bridge.ConcreteDispatcher.RaiseAccelerate(
                        current_angular_acceleration_target.Select(
                            (e, idx) 
                                => new { 
                                    Value = e, 
                                    IsMandatory = this.FSM.CurrentSettings.phase_B_settings.angular_mandatory_axis[idx] 
                                }
                        ).Select(
                            x => (
                        ...
                        current_linear_acceleration_target.Select(
                            (e, idx) 
                                => new { 
                                    Value = e, 
                                    IsMandatory = this.FSM.CurrentSettings.phase_B_settings.linear_mandatory_axis[idx] 
                                }
                        ).Select(
                            x => (
                                x.IsMandatory ? x.Value : 0.0f
                        ...
                        this.FSM.CurrentSettings.phase_B_settings.stim_duration,
                        (
                ...
                var phase_running_task 
                    = System.Threading.Tasks.Task.Factory.StartNew(
                        ...
                        { 
                            ...
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : waiting for idle state"
                            );
                    ...
                    // then sleep remaining idle time & raise end
                        ...
                        { 
                            ...
                            UnityEngine.Debug.Log(
                                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : waiting [" 
                            ...
                            await apollon.ApollonHighResolutionTime.DoSleep(this.FSM.CurrentSettings.phase_B_settings.total_duration - ( 2.0f * this.FSM.CurrentSettings.phase_B_settings.stim_duration ));
                ...
                // log
                UnityEngine.Debug.Log(
                    "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : reaching phase end"
                );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnEntry() : end"
            );
        ...
        public async override System.Threading.Tasks.Task OnExit()
        {
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnExit() : begin"
            );
            ...
            // log
            UnityEngine.Debug.Log(
                "<color=Blue>Info: </color> AgencyAndThresholdPerceptionV2PhaseB.OnExit() : end"
            );
